...
Ce dépôt ne contient pas seulement du code, mais la réponse technique à une analyse de risques formelle. Vous trouverez dans le dossier "Livrable GRC" l'étude EBIOS RM complète ayant motivé le développement de cet outil et, un second livrable sur le secteur industriel.
